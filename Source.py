...
class Source:
    ...
    def DispGameOver(retbutton_image, gameover_image):
        retbutton_rect = retbutton_image.get_rect()
        retbutton_rect.centerx = Source.width / 2
        retbutton_rect.top = Source.height * 0.52

        gameover_rect = gameover_image.get_rect()
        gameover_rect.centerx = Source.width / 2
        gameover_rect.centery = Source.height * 0.35

        Source.screen.blit(retbutton_image, retbutton_rect)
        Source.screen.blit(gameover_image, gameover_rect)
